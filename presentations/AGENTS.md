...
- Keep `<aside class="progress" aria-label="Presentation progress"></aside>` and `<aside class="clock" aria-label="Presentation timer"></aside>` in place for timing (these must be landmark elements for WCAG 2.1 compliance).
