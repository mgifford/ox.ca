...
## Example RFP clause: Upstream Contribution
...
## Example RFP clause: Public Repository Requirement
...
## Example RFP clause: Maintenance Escrow
...
## Evaluation checklist (acceptance team)
- PR links provided for all fixes/features
- Public repository URL provided and accessible
- LICENSE, README, and CONTRIBUTING present
- Release tag or changelog created
- CI checks pass for security/accessibility where applicable
- Evidence of maintainer engagement (issues, PR comments, merges)

## Notes
- Remove long RFP language from slides and include this handout as a downloadable resource/QR code link on the Resources slide.
- Keep slide examples short and point attendees to this handout for copy-paste clauses.
